...
/**
     ...
     * @apiParam {String} title title of the blog passed as body parameter
     * @apiParam {String} description description of the blog passed as a body parameter.
     * @apiParam {String} blogBody blogBody of the Blog passed as body parameter.
     * @apiParam {String} category category of the blog passed as the body parameter.
     * 
     * @apiSuccessExample {json} Success-Response:
     * {
     * "error": false,
